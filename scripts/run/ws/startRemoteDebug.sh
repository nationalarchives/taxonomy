...
$javaBinary -jar -Dspring.profiles.active=${profile} $@ -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=9003 ${wsPackageFolder}/taxonomy-ws-${taxonomyJarVersion}.war 
